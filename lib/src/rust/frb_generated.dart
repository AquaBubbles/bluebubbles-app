...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -1153294413;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> configureMacos(
      {required ArcPushState state, required RelayConfig config, dynamic hint});
  ...
  Future<int> dartAttachmentGetSize(
      {required DartAttachment that, dynamic hint});

  Future<DartAttachment> dartAttachmentRestore(
      {required String saved, dynamic hint});

  Future<String> dartAttachmentSave(
      {required DartAttachment that, dynamic hint});
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_RelayConfig;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_RelayConfig;

  CrossPlatformFinalizerArg get rust_arc_decrement_strong_count_RelayConfigPtr;
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> configureAppReview({required ArcPushState state, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kConfigureAppReviewConstMeta,
      argValues: [state],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kConfigureAppReviewConstMeta => const TaskConstMeta(
  ...
  Future<void> configureMacos(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kConfigureMacosConstMeta,
  ...
  TaskConstMeta get kConfigureMacosConstMeta => const TaskConstMeta(
  ...
  Future<String> convertTokenToUuid(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kConvertTokenToUuidConstMeta,
  ...
  TaskConstMeta get kConvertTokenToUuidConstMeta => const TaskConstMeta(
  ...
  Future<int> dartAttachmentGetSize(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDartAttachmentGetSizeConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDartAttachmentGetSizeConstMeta => const TaskConstMeta(
  ...
  Future<DartAttachment> dartAttachmentRestore(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDartAttachmentRestoreConstMeta,
      argValues: [saved],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDartAttachmentRestoreConstMeta => const TaskConstMeta(
  ...
  Future<String> dartAttachmentSave(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDartAttachmentSaveConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDartAttachmentSaveConstMeta => const TaskConstMeta(
  ...
  Future<String> dartMessagePartsAsPlain(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDartMessagePartsAsPlainConstMeta,
      argValues: [that],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDartMessagePartsAsPlainConstMeta => const TaskConstMeta(
  ...
  Future<void> doReregister({required ArcPushState state, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kDoReregisterConstMeta,
      argValues: [state],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kDoReregisterConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kDownloadAttachmentConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kGet2FaSmsOptsConstMeta => const TaskConstMeta(
  ...
  Future<DartDeviceInfo> getDeviceInfoState(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kGetDeviceInfoStateConstMeta,
      argValues: [state],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kGetDeviceInfoStateConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kGetHandlesConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kGetPhaseConstMeta => const TaskConstMeta(
        debugName: "get_phase",
        argNames: ["state"],
      );
  ...
  Future<List<DartPrivateDeviceInfo>> getSmsTargets(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kGetSmsTargetsConstMeta,
  ...
  TaskConstMeta get kGetSmsTargetsConstMeta => const TaskConstMeta(
  ...
  Future<void> invalidateIdCache({required ArcPushState state, dynamic hint}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kInvalidateIdCacheConstMeta,
      argValues: [state],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kInvalidateIdCacheConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kNewMsgConstMeta => const TaskConstMeta(
        debugName: "new_msg",
  ...
  TaskConstMeta get kNewPushStateConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kPtrToDartConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kRecvWaitConstMeta => const TaskConstMeta(
        debugName: "recv_wait",
        argNames: ["state"],
      );
  ...
  TaskConstMeta get kRegisterIdsConstMeta => const TaskConstMeta(
  ...
  Future<DartLoginState> send2FaSms(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kSend2FaSmsConstMeta,
  ...
  TaskConstMeta get kSend2FaSmsConstMeta => const TaskConstMeta(
  ...
  Future<DartLoginState> send2FaToDevices(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kSend2FaToDevicesConstMeta,
      argValues: [state],
      apiImpl: this,
      hint: hint,
    ));
  ...
  TaskConstMeta get kSend2FaToDevicesConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kTryAuthConstMeta => const TaskConstMeta(
        debugName: "try_auth",
  ...
  TaskConstMeta get kUploadAttachmentConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kUploadMmcsConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kValidateTargetsConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kVerify2FaConstMeta => const TaskConstMeta(
  ...
  Future<DartLoginState> verify2FaSms(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kVerify2FaSmsConstMeta,
  ...
  TaskConstMeta get kVerify2FaSmsConstMeta => const TaskConstMeta(
  ...
  VerifyBody
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerVerifyBody(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return VerifyBody.dcoDecode(raw as List<dynamic>);
  }
  ...
  RelayConfig
      dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerRelayConfig(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return RelayConfig.dcoDecode(raw as List<dynamic>);
  }
  ...
  DartChangeParticipantMessage dco_decode_dart_change_participant_message(
    ...
    return DartChangeParticipantMessage(
      ...
      groupVersion: dco_decode_u_64(arr[1]),
    );
  }
  ...
  DartDeviceInfo dco_decode_dart_device_info(dynamic raw) {
    ...
    return DartDeviceInfo(
      ...
      encodedData: dco_decode_list_prim_u_8_strict(arr[3]),
    );
  }
  ...
  DartEditMessage dco_decode_dart_edit_message(dynamic raw) {
    ...
    return DartEditMessage(
      ...
      editPart: dco_decode_u_64(arr[1]),
  ...
  DartIndexedMessagePart dco_decode_dart_indexed_message_part(dynamic raw) {
    ...
    return DartIndexedMessagePart(
      part: dco_decode_dart_message_part(arr[0]),
      idx: dco_decode_opt_box_autoadd_usize(arr[1]),
  ...
  DartAttachment sse_decode_dart_attachment(SseDeserializer deserializer) {
    ...
    var var_partIdx = sse_decode_u_64(deserializer);
  ...
  DartChangeParticipantMessage sse_decode_dart_change_participant_message(
    ...
    var var_groupVersion = sse_decode_u_64(deserializer);
    return DartChangeParticipantMessage(
  ...
  DartDeviceInfo sse_decode_dart_device_info(SseDeserializer deserializer) {
    ...
    var var_encodedData = sse_decode_list_prim_u_8_strict(deserializer);
    return DartDeviceInfo(
        name: var_name,
        serial: var_serial,
  ...
  DartEditMessage sse_decode_dart_edit_message(SseDeserializer deserializer) {
    ...
    var var_editPart = sse_decode_u_64(deserializer);
  ...
  DartIndexedMessagePart sse_decode_dart_indexed_message_part(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_part = sse_decode_dart_message_part(deserializer);
    var var_idx = sse_decode_opt_box_autoadd_usize(deserializer);
    var var_ext = sse_decode_opt_box_autoadd_dart_part_extension(deserializer);
    return DartIndexedMessagePart(part: var_part, idx: var_idx, ext: var_ext);
  }
  ...
  DartReactMessage sse_decode_dart_react_message(SseDeserializer deserializer) {
    ...
    var var_toPart = sse_decode_u_64(deserializer);
  ...
  MMCSTransferProgress sse_decode_mmcs_transfer_progress(
      SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_prog = sse_decode_usize(deserializer);
  ...
  void sse_encode_dart_attachment(
    ...
    sse_encode_u_64(self.partIdx, serializer);
  ...
  void sse_encode_dart_change_participant_message(
    ...
    sse_encode_u_64(self.groupVersion, serializer);
  }
  ...
  void sse_encode_dart_device_info(
    ...
    sse_encode_list_prim_u_8_strict(self.encodedData, serializer);
  }
  ...
  void sse_encode_dart_edit_message(
    ...
    sse_encode_u_64(self.editPart, serializer);
  ...
  void sse_encode_dart_indexed_message_part(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_dart_message_part(self.part, serializer);
    sse_encode_opt_box_autoadd_usize(self.idx, serializer);
  ...
  void sse_encode_dart_react_message(
    ...
    sse_encode_u_64(self.toPart, serializer);
  ...
  void sse_encode_mmcs_transfer_progress(
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(self.prog, serializer);
